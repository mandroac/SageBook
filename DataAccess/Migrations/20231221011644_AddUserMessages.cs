    ...
    public partial class AddUserMessages : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookMessages_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookMessages_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookMessages_BookId",
                table: "BookMessages",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookMessages_SenderId",
                table: "BookMessages",
                column: "SenderId");
